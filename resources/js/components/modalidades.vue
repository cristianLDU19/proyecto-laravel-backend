        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card card-default carta">
                    <div class="card-header cabeza">TRIVIA DE COMMIDA</div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card card-default carta">
                    ...
                    <div class="card-body">
                        <a href="/receta"><img class="card-img"  src="https://firebasestorage.googleapis.com/v0/b/sistemacalificaciones-78da3.appspot.com/o/carreraChefs.png?alt=media&token=8e54e8a8-82b1-450a-872e-618e2c179f17"></a>
                    </div>
                </div>
            </div>
        </div>
